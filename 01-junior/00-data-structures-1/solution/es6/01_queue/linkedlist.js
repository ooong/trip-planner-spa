...
class LinkedList {
    ...
    //Using es6 classes with prototypal methods
    addToHead(v) {
    ...
    search(comparator) {
        ...
        // es6 variable declaration with `let`: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/let
        // This limits scope more than `var`, but can be reassigned unlike `const`
